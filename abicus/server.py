...
from abicus.apps.mortgage.router import api_router as mortgage_api, views_router as mortgage_views
...
for _name in ("outflows", "assets", "claims", "mortgage"):
    app.mount(
        f"/{_name}/static",
...
app.include_router(mortgage_views, prefix="/mortgage")
...
app.include_router(mortgage_api, prefix="/api/mortgage")
